...
namespace KF.Remoting
{
    ...
    sealed class ClientAgent
    {
        ...
        /// 是否存活
        /// </summary>
        public bool IsAlive { get { return MaxActiveTicks > Global.NowTime.Ticks; } }

        /// <summary>
        /// 是否存活
        /// </summary>
        public bool IsDead { get { return MaxDeadTicks < Global.NowTime.Ticks; } }
        ...
        /// 总人数负载
        /// </summary>
        public long TotalRolePayload { get { return TotalFubenRolePayLoad + TotalMainlineRolePayLoad; } }
