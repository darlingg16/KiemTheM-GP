...
namespace KF.Remoting
{
    ...
    public static class KuaFuServerManager
    {
        ...
        public static bool LoadConfig()
        {
            lock (Mutex)
            {
                try
                {
                    ...
                    #endregion DONECONFIG MAPLINE

                    #region LOAD OTHER CONFIG
        ...
        public static string GetResourcePath(string fileName, ResourcePathTypes resType)
        {
            ...
            //    switch (resType)
            //    {
            //        case ResourcePathTypes.Application: return string.Format("{0}{1}/{2}", ResourcePath, DataHelper2.CurrentDirectory, fileName);
            //        case ResourcePathTypes.GameRes: return string.Format("{0}{1}/{2}", ResourcePath, "/GameRes", fileName);
            //        case ResourcePathTypes.Isolate: return string.Format("{0}{1}/{2}", ResourcePath, "/ServerRes/1/IsolateRes", fileName);
            //        case ResourcePathTypes.Map: return string.Format("{0}{1}/{2}", ResourcePath, "/Map", fileName);
            //        case ResourcePathTypes.MapConfig: return string.Format("{0}{1}/{2}", ResourcePath, "/MapConfig", fileName);
            //    }
            //}
            //else
            //{
            ...
            //        case ResourcePathTypes.Application: return string.Format("{0}{1}/{2}", ResourcePath, DataHelper2.CurrentDirectory, fileName);
            //        case ResourcePathTypes.GameRes: return string.Format("{0}{1}/{2}", ResourcePath, "/GameRes", fileName);
            //        case ResourcePathTypes.Isolate: return string.Format("{0}{1}/{2}", ResourcePath, "/IsolateRes", fileName);
            //        case ResourcePathTypes.Map: return string.Format("{0}{1}/{2}", ResourcePath, "/GameRes/Map", fileName);
            //        case ResourcePathTypes.MapConfig: return string.Format("{0}{1}/{2}", ResourcePath, "/GameRes/MapConfig", fileName);
            //    }
            //}
        ...
        /// </summary>
        static GetKuaFuServerListRequestData KuaFuServerListRequestData = new GetKuaFuServerListRequestData();

        /// <summary>
        /// 服务器信息
        /// </summary>
        static ConcurrentDictionary<int, KuaFuServerInfo> _ServerIdServerInfoDict = new ConcurrentDictionary<int, KuaFuServerInfo>();
