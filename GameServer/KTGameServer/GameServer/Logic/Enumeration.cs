...
namespace GameServer.Logic
{
    ...
    {
        MainTask = 0,       //Nhiệm vụ chính
        MonPhai = 1,    //Quân sự hàng ngày
        NghiaQuan = 2,     //Đi săn hàng ngày
        ThuongHoi = 3,     //Đi săn hàng ngày
        HaiTac = 4,        //Nhiệm vụ tuần hoàn ？
        TheGioi = 5,       //Mozu Gang
    }
    ...
    public enum ActivityTypes
    {
        ...
        HeFuLogin = 20, //QUà đăng nhập đồng máy chủ
        ...
        MeiRiChongZhiHaoLi = 27,  // Quà nạp tiền hàng ngày  [7/15/2013 LiaoWei]
    ...
    public enum WeeklyActivityRecord
    {
        ...
        /// </summary>
        MilitaryCamp_TotalParticipatedTimes = 1000001,
    }
    ...
    public class RoleParamName
    {
        ...
        public const String CurBVDTaskID = "CurBVDTaskID"; // Nhiệm vụ BVD hiện tại
        public const String QuestBVDTodayCount = "QuestBVDTodayCount"; // Tổng số nhiệm vụ bạo văn đồng đã làm trong ngày
        public const String CanncelQuestBVD = "CanncelQuestBVD"; // Tổng số nhiệm vụ đã hủy trong ngày
        public const String QuestBVDStreakCount = "QuestBVDStreakCount"; // Tổng số nhiệm vụ đã hủy trong ngày
    ...
    public static class VIPEumValue
    {
        ...
        public const int VIPENUMVALUE_GOODBoundMoney = 7037;   // VIP影响的果实ID
