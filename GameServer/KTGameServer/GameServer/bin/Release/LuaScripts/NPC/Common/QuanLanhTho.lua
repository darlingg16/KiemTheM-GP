...
function QuanLanhTho:OnOpen(scene, npc, player, otherParams)
	...
	dialog:AddSelection(3, "Phần thưởng chinh chiến")
	dialog:AddSelection(5, "Thiết lập thành chính")
...
function QuanLanhTho:OnSelection(scene, npc, player, selectionID, otherParams)
	...
	local dialog = GUI.CreateNPCDialog()
	if selectionID == 1 or selectionID == 2 or selectionID == 3 or selectionID == 4 or selectionID == 5  then
