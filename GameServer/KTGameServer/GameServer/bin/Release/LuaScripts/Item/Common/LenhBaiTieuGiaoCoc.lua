...
local LenhBaiTieuGiaoCoc = Scripts[200069]
...
-- ****************************************************** --
function LenhBaiTieuGiaoCoc:OnPreCheckCondition(scene, item, player, otherParams)

	-- ************************** --
	--player:AddNotification("Enter -> LenhBaiTieuGiaoCoc:OnPreCheckCondition")--
	-- ************************** --
	return true
	-- ************************** --
...
--		player: Player - NPC tương ứng
-- ****************************************************** --
function LenhBaiTieuGiaoCoc:OnUse(scene, item, player, otherParams)
	...
	Player.AddRetupeValue(player,503,10)
...
-- ****************************************************** --
function LenhBaiTieuGiaoCoc:OnSelection(scene, item, player, selectionID, otherParams)

	-- ************************** --
	--player:AddNotification("Enter -> LenhBaiTieuGiaoCoc:OnSelection, selectionID = " .. selectionID)--
...
-- ****************************************************** --
function LenhBaiTieuGiaoCoc:OnItemSelected(scene, item, player, itemID)
