...
function ThungRuou:OnPreCheckCondition(scene, item, player, otherParams)
	...
	-- ************************** --
	--player:AddNotification("Enter -> ThungRuou:OnPreCheckCondition")--
	-- ************************** --
	return true
	-- ************************** --
...
function ThungRuou:OnSelection(scene, item, player, selectionID, otherParams)
	...
	-- ************************** --
	--player:AddNotification("Enter -> ThungRuou:OnSelection, selectionID = " .. selectionID)--
