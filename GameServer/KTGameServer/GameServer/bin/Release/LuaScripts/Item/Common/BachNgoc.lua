...
-- ****************************************************** --
function BachNgoc:OnPreCheckCondition(scene, item, player, otherParams)

	-- ************************** --
	--player:AddNotification("Enter -> BachNgoc:OnPreCheckCondition")--
	-- ************************** --
	return true
	-- ************************** --
...
--		player: Player - NPC tương ứng
-- ****************************************************** --
function BachNgoc:OnUse(scene, item, player, otherParams)
	...
	Player.AddRetupeValue(player,1201,100)
...
-- ****************************************************** --
function BachNgoc:OnSelection(scene, item, player, selectionID, otherParams)

	-- ************************** --
	--player:AddNotification("Enter -> BachNgoc:OnSelection, selectionID = " .. selectionID)--
...
-- ****************************************************** --
function BachNgoc:OnItemSelected(scene, item, player, itemID)
