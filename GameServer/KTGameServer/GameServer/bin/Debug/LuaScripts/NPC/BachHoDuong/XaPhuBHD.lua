...
-- ****************************************************** --
function XaPhuBHD:OnOpen(scene, npc, player, otherParams)
...
-- ****************************************************** --
function XaPhuBHD:OnSelection(scene, npc, player, selectionID,otherParams)
...
-- ****************************************************** --
function XaPhuBHD:OnItemSelected(scene, npc, player, itemID,otherParams)
...
function XaPhuBHD:ChangeScene(player,ID,PosX, PosY)

	-- ************************** --
		XaPhuBHD:ChangeScene(player,ID,Posx,PosY)
	
	-- ************************** --

end
function XaPhuBHD:ShowDialog(npc, player, text)
