...
local ValueMoney = {50000,500000};
local MoneyType = 0;
local DinhVangDuLong = Scripts[200079]
...
-- ****************************************************** --
function DinhVangDuLong:OnPreCheckCondition(scene, item, player, otherParams)

	-- ************************** --
	--player:AddNotification("Enter -> DinhVangDuLong:OnPreCheckCondition")--
	-- ************************** --
	return true
	-- ************************** --
...
--		player: Player - NPC tương ứng
-- ****************************************************** --
function DinhVangDuLong:OnUse(scene, item, player, otherParams)
...
-- ****************************************************** --
function DinhVangDuLong:OnSelection(scene, item, player, selectionID, otherParams)

	-- ************************** --
	--player:AddNotification("Enter -> DinhVangDuLong:OnSelection, selectionID = " .. selectionID)--
...
-- ****************************************************** --
function DinhVangDuLong:OnItemSelected(scene, item, player, itemID)
