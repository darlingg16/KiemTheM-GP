...
namespace GameServer.KiemThe.Core
{
    ...
    public class KDynamicArea : IObject
    {
        ...
        public void ProcessTick()
        {
            ...
            UnityEngine.Vector2 selfPos = new UnityEngine.Vector2((int) this.CurrentPos.X, (int) this.CurrentPos.Y);
            List<GameObject> nearByObjects = KTLogic.GetNearByObjectsAtPos<GameObject>(this.CurrentMapCode, this.CurrentCopyMapID, selfPos, this.Radius);
        ...
        public Action<KDynamicArea> OnCostumeTick { get; set; }
        /// <summary>
