...
namespace GameServer.KiemThe.Core.Activity.LuckyCircle
{
    ...
    public static class KTLuckyCircleManager
    {
        ...
        public static void Init()
        {
            ...
            XElement xmlNode = Global.GetGameResXml("Config/KT_Activity/KTLuckyCircle.xml");
        ...
        {
            return KTLuckyCircleManager.Data.Config.Activate;
        }
        ...
        public static void OpenCircle(KPlayer player)
        {
            ...
            {
                PlayerManager.ShowNotification(player, "Vòng quay may mắn hiện chưa mở, hãy quay lại sau!");
                return;
            }
            /// Nếu cấp độ không đủ
            else if (player.m_Level < KTLuckyCircleManager.Data.Config.LimitLevel)
            {
                PlayerManager.ShowNotification(player, string.Format("Cần đạt cấp {0} trở lên mới có thể mở vòng quay may mắn!", KTLuckyCircleManager.Data.Config.LimitLevel));
                return;
            }
        ...
        public static bool GetAward(KPlayer player)
        {
            ...
            {
                PlayerManager.ShowNotification(player, "Thao tác quá nhanh, hãy đợi giây lát và thử lại!");
                return false;
            }
            /// Đánh dấu thời điểm
            ...
            {
                /// Thông báo
                PlayerManager.ShowNotification(player, "Không có phần thưởng có thể nhận.");
                /// Trả về kết quả
                return false;
            }
            ...
            {
                /// Thông báo
                PlayerManager.ShowNotification(player, string.Format("Cần sắp xếp tối thiểu {0} ô trống trong túi để nhận phần thưởng!", spaceNeed));
                /// Trả về kết quả
                return false;
            }
            ...
            if (!ItemManager.CreateItem(Global._TCPManager.TcpOutPacketPool, player, cell.ItemID, cell.Quantity, 0, "LuckyCircle", true, player.LuckyCircle_AwardBound ? 1 : 0, false, Global.ConstGoodsEndTime))
            {
                /// Thông báo
        ...
        public static bool StartTurn(KPlayer player, LuckyCirclePlayMethod method, out int stopPos)
        {
            ...
            {
                /// Thông báo
                PlayerManager.ShowNotification(player, string.Format("Cần đạt cấp {0} trở lên mới có thể bắt đầu lượt quay!", KTLuckyCircleManager.Data.Config.LimitLevel));
                /// Trả về kết quả
                return false;
            }
            ...
            if (method == LuckyCirclePlayMethod.UseToken)
            {
                ...
                {
                    /// Thông báo
                    PlayerManager.ShowNotification(player, string.Format("Cần có {0} đồng mới có thể bắt đầu lượt quay!", KTLuckyCircleManager.Data.Requiration.RequireToken));
                    /// Trả về kết quả
                    return false;
                }
            }
            ...
            else if (method == LuckyCirclePlayMethod.UseBoundToken)
            {
                ...
                {
                    /// Thông báo
                    PlayerManager.ShowNotification(player, string.Format("Cần có {0} đồng khóa mới có thể bắt đầu lượt quay!", KTLuckyCircleManager.Data.Requiration.RequireBoundToken));
                    /// Trả về kết quả
                    return false;
                }
            }
            ...
            else if (method == LuckyCirclePlayMethod.UseItem)
            {
                ...
                {
                    /// Thông báo
                    PlayerManager.ShowNotification(player, string.Format("Cần có [{0}] mới có thể bắt đầu lượt quay!", KTGlobal.GetItemName(KTLuckyCircleManager.Data.Requiration.RequireItemID)));
                    /// Trả về kết quả
                    return false;
                }
            }
            ...
            {
                /// Thông báo
                PlayerManager.ShowNotification(player, "Thao tác bị lỗi, hãy thử lại sau!");
                /// Trả về kết quả
                return false;
            }
            ...
            {
                /// Thông báo
                PlayerManager.ShowNotification(player, "Có phần thưởng chưa nhận, hãy ấn Nhận thưởng trước tiên.");
                /// Trả về kết quả
                return false;
            }
            ...
            else
            {
                ...
                {
                    /// Thông báo
                    PlayerManager.ShowNotification(player, "Thao tác quay bị lỗi, hãy liên hệ với Admin để báo cáo.");
                    /// Ghi Log
