...
namespace GameServer.KiemThe.Core.Task
{
    ...
    public class MainTaskManager
    {
        ...
        public void AswerQuestion(GameMap map, NPC npc, KPlayer client, TaskCallBack TaskData, int TaskID)
        {
            ...
            if (_TaskGet != null)
            {
                ...
                else
                {
                    ...
                    if (TaskPram.Length > 0)
                    {
                        ...
                        /// Sói FIX Index was outside the bounds of the array.
                        ...
                        else
                        {
                            ...
                            if (Aswer.Contains("#"))
                            {
                                ...
                                PlayerManager.ShowNotification(client, "Rất tốt người đã trả lời đúng!");
            ...
            {
                PlayerManager.ShowNotification(client, "Có lỗi khi nhận nhiệm vụ");
            }
        }
        ...
        public void GenEndQuestData(GameMap map, NPC npc, KPlayer client, int TaskID)
        {
           // LogManager.WriteLog(LogTypes.Quest, "GEN ENDQEST DATA :" + TaskID);
            ...
            if (_TaskGet != null)
            {
                _NpcDialog.Text = KTGlobal.CreateStringByColor("Nhiệm Vụ :", ColorType.Accpect) + _TaskGet.Title + "<br><br>" + KTGlobal.CreateStringByColor(npc.Name + ":", ColorType.Accpect) + "<br><br>" + _TaskGet.CompleteTalk;
            ...
            {
                PlayerManager.ShowNotification(client, "Có lỗi khi trả nhiệm vụ");
            }
        }
                    ...
                    if (_TaskGet != null)
                    {
                        ...
                        if (_FindTaskData != null)
                        {
                            ...
                            else if (!TaskManager.getInstance().IsQuestComplete(_TaskGet.ID, _FindTaskData.DoingTaskVal1) && _TaskGet.TargetType == (int)TaskTypes.AnswerQuest)
                            {
                                ...
                                {
                                    PlayerManager.ShowNotification(client, "Config nhiệm vụ bị lỗi");
                                    return;
                                }
                            }
                            else
        ...
        public void GenAccpectQuestData(GameMap map, NPC npc, KPlayer client, int TaskID)
        {
            ...
            if (_TaskGet != null)
            {
                ...
                {
                    _NpcDialog.Text = KTGlobal.CreateStringByColor("Nhiệm Vụ :", ColorType.Accpect) + _TaskGet.Title + "<br><br>" + KTGlobal.CreateStringByColor("Mục Tiêu :", ColorType.Importal) + "<br><br>" + _TaskGet.DoingTalk;
