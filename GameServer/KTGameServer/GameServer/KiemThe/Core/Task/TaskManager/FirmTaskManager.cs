...
namespace GameServer.KiemThe.Core.Task
{
    ...
    public class FirmTaskManager
    {
        ...
        {
            int Count = client.GetValueOfWeekRecore((int)RecoreDef.FirmMoneyExchange);
        ...
        {
            client.SetValueOfWeekRecore((int)RecoreDef.FirmMoneyExchange, Value);
        }
        ...
        {
            int Count = client.GetValueOfWeekRecore((int)RecoreDef.FirmTaskCurNum);
        ...
        {
            client.SetValueOfWeekRecore((int)RecoreDef.FirmTaskCurNum, Value);
        }

        public int GetQuestID(KPlayer client)
        {
            int Count = client.GetValueOfWeekRecore((int)RecoreDef.FirmTaskCurID);
        ...
        {
            client.SetValueOfWeekRecore((int)RecoreDef.FirmTaskCurID, Value);
        }
