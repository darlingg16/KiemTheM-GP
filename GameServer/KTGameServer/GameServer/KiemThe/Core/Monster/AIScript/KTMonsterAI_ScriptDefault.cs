    ...
    public class KTMonsterAI_ScriptDefault : IMonsterAIScript
	{
		...
		private readonly Dictionary<int, Dictionary<int, SkillInfo>> AISkillList = new Dictionary<int, Dictionary<int, SkillInfo>>()
		{
			...
			{ 1, new Dictionary<int, SkillInfo>()
				{
					{0,  new SkillInfo() { ID = 308, Cooldown = 0, Series = KE_SERIES_TYPE.series_none, CastRange = 80, } },
					{1,  new SkillInfo() { ID = 309, Cooldown = 0, Series = KE_SERIES_TYPE.series_metal, CastRange = 80, } },
					{2,  new SkillInfo() { ID = 310, Cooldown = 0, Series = KE_SERIES_TYPE.series_wood, CastRange = 80, } },
					{3,  new SkillInfo() { ID = 311, Cooldown = 0, Series = KE_SERIES_TYPE.series_water, CastRange = 80, } },
					{4,  new SkillInfo() { ID = 312, Cooldown = 0, Series = KE_SERIES_TYPE.series_fire, CastRange = 80, } },
					{5,  new SkillInfo() { ID = 313, Cooldown = 0, Series = KE_SERIES_TYPE.series_earth, CastRange = 80, } },
				}
			},
			/// Kỹ năng tầm trung
			{ 2, new Dictionary<int, SkillInfo>()
				{
					{0,  new SkillInfo() { ID = 314, Cooldown = 11000, Series = KE_SERIES_TYPE.series_none, CastRange = 300, } },
					{1,  new SkillInfo() { ID = 315, Cooldown = 11000, Series = KE_SERIES_TYPE.series_metal, CastRange = 300, } },
					{2,  new SkillInfo() { ID = 316, Cooldown = 11000, Series = KE_SERIES_TYPE.series_wood, CastRange = 300, } },
					{3,  new SkillInfo() { ID = 317, Cooldown = 11000, Series = KE_SERIES_TYPE.series_water, CastRange = 300, } },
					{4,  new SkillInfo() { ID = 318, Cooldown = 11000, Series = KE_SERIES_TYPE.series_fire, CastRange = 300, } },
					{5,  new SkillInfo() { ID = 319, Cooldown = 11000, Series = KE_SERIES_TYPE.series_earth, CastRange = 300, } },
				}
			},
			/// Kỹ năng tầm xa
			{ 3, new Dictionary<int, SkillInfo>()
				{
					{0,  new SkillInfo() { ID = 320, Cooldown = 30000, Series = KE_SERIES_TYPE.series_none, CastRange = 520 } },
					{1,  new SkillInfo() { ID = 321, Cooldown = 30000, Series = KE_SERIES_TYPE.series_metal, CastRange = 520, } },
					{2,  new SkillInfo() { ID = 322, Cooldown = 30000, Series = KE_SERIES_TYPE.series_wood, CastRange = 520, } },
					{3,  new SkillInfo() { ID = 323, Cooldown = 30000, Series = KE_SERIES_TYPE.series_water, CastRange = 520, } },
					{4,  new SkillInfo() { ID = 324, Cooldown = 30000, Series = KE_SERIES_TYPE.series_fire, CastRange = 520, } },
					{5,  new SkillInfo() { ID = 325, Cooldown = 30000, Series = KE_SERIES_TYPE.series_earth, CastRange = 520, } },
				}
			},
		};
