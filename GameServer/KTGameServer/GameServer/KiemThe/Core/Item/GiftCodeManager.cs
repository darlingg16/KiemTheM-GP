    ...
    public class GiftCodeManager
    {
        ...
        public static void ActiveGiftCode(KPlayer player, string CodeAcive)
        {
            ...
            if (Now - player.GetLiPinMaTicks > 10000)
            {
                ...
                {
                    PlayerManager.ShowMessageBox(player, "Thông báo", "Không đủ chỗ trống để nhận thưởng");
                    return;
                }
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        foreach (string Item in ItemList)
                        {
                            ...
                            if (!ItemManager.CreateItem(Global._TCPManager.TcpOutPacketPool, player, ItemID, ItemNum, 0, "ActiveGiftCode", false, 1, false, Global.ConstGoodsEndTime))
                            {
