...
namespace GameServer.Logic
{
	...
	public partial class GameObject
	{
		...
		/// Kháng làm chậm
		/// </summary>
		public bool m_CurrentSlowMissile { get; set; }
		...
		/// Tỷ lệ hút sinh lực
		/// </summary>
		public int m_nStealLifeRate { get; set; }
		/// <summary>
		/// Tỷ lệ hút nội lực
		/// </summary>
		public int m_nStealManaRate { get; set; }
		/// <summary>
		/// Tỷ lệ hút thể lực
		/// </summary>
		public int m_nStealStaminaRate { get; set; }
		...
		public int GetCurrentAttackSpeed()
        {
            ...
            {
				/// Nếu không ảnh hưởng bởi tốc đánh
				if (!player.m_cPlayerFaction.UseAS())
                {
					return 0;
                }
            }
		...
		/// <summary>
		/// Thêm giá trị kháng thuộc tính tương ứng hiện tại
		/// </summary>
		/// <param name="eType"></param>
		/// <returns></returns>
		...
		/// <summary>
		/// Thiết lập giá trị kháng thuộc tính tương ứng hiện tại
		/// </summary>
