...
namespace GameServer.Logic
{
    ...
    public partial class GameObject
    {
        ...
        /// <summary>
        /// Tên đối tượng đả thương
        /// </summary>
        private string WhoKilledMeName = "Chưa rõ";
                        ...
                        if (castSkill != null)
                        {
                            ...
                            if (buff != null && buff.CurseOwner != null)
                            {
                                if (target != null)
                                {
                                    ...
                                    if (!target.IsDead())
                                    {
                                        KTSkillManager.UseSkill(buff.CurseOwner, this, castSkill, true, new UnityEngine.Vector2((int) target.CurrentPos.X, (int) target.CurrentPos.Y));
                                    }
                                }
                                else
                                {
                                    KTSkillManager.UseSkill(buff.CurseOwner, this, castSkill, true);
                                }
                            }
                            else
                            {
                                if (target != null)
                                {
                                    ...
                                    if (!target.IsDead())
                                    {
                                        KTSkillManager.UseSkill(this, target, castSkill, true, new UnityEngine.Vector2((int) target.CurrentPos.X, (int) target.CurrentPos.Y));
                                    }
                                }
                                else
                                {
                                    KTSkillManager.UseSkill(this, target, castSkill, true);
                                }
                            }
                        }
                    }
