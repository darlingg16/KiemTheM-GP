...
namespace GameServer.KiemThe.Core.Rechage
{
    public class RechageServiceManager
    {
        ...
        public static void SendRequestByThreading(byte[] SendDATA, NPC npc, KPlayer client)
        {
            ...
            if (Check1 == -1)
            {
                Selections.Add((int)RecoreDef.IAP_Pack1, "<b><color=#00ff2a>Gói 4500 Đồng</color></b> cần <b>4500 KTCoin</b>" + KTGlobal.CreateStringByColor("(Có Khuyến Mại)", ColorType.Green) + "</b>");
            }
            else
            {
                Selections.Add((int)RecoreDef.IAP_Pack1, "<b><color=#00ff2a>Gói 4500 Đồng</color></b> cần <b>4500 KTCoin</b>");
            }

            if (Check2 == -1)
            {
                Selections.Add((int)RecoreDef.IAP_Pack2, "<b><color=#00ff2a>Gói 6900 Đồng</color></b> cần <b>6900 KTCoin</b>" + KTGlobal.CreateStringByColor("(Có Khuyến Mại)", ColorType.Green) + "</b>");
            }
            else
            {
                Selections.Add((int)RecoreDef.IAP_Pack2, "<b><color=#00ff2a>Gói 6900 Đồng</color></b> cần <b>6900 KTCoin</b>");
            }

            if (Check3 == -1)
            {
                Selections.Add((int)RecoreDef.IAP_Pack3, "<b><color=#00ff2a>Gói 12900 Đồng</color></b> cần <b>12900 KTCoin</b>" + KTGlobal.CreateStringByColor("(Có Khuyến Mại)", ColorType.Green) + "</b>");
            }
            else
            {
                Selections.Add((int)RecoreDef.IAP_Pack3, "<b><color=#00ff2a>Gói 12900 Đồng</color></b> cần <b>12900 KTCoin</b>");
            }

            if (Check4 == -1)
            {
                Selections.Add((int)RecoreDef.IAP_Pack4, "<b><color=#00ff2a>Gói 69900 Đồng</color></b> cần <b>69900 KTCoin</b>" + KTGlobal.CreateStringByColor("(Có Khuyến Mại)", ColorType.Green) + "</b>");
            }
            else
            {
                Selections.Add((int)RecoreDef.IAP_Pack4, "<b><color=#00ff2a>Gói 69900 Đồng</color></b> cần <b>69900 KTCoin</b>");
            }

            if (Check5 == -1)
            {
                Selections.Add((int)RecoreDef.IAP_Pack5, "<b><color=#00ff2a>Gói 129900 Đồng</color></b> cần <b>129900 KTCoin</b>" + KTGlobal.CreateStringByColor("(Có Khuyến Mại)", ColorType.Green) + "</b>");
            }
            else
            {
                Selections.Add((int)RecoreDef.IAP_Pack5, "<b><color=#00ff2a>Gói 129900 Đồng</color></b> cần <b>129900 KTCoin</b>");
            }

            if (Check6 == -1)
            {
                Selections.Add((int)RecoreDef.IAP_Pack6, "<b><color=#00ff2a>Gói 199900 Đồng</color></b> cần <b>199900 KTCoin</b>" + KTGlobal.CreateStringByColor("(Có Khuyến Mại)", ColorType.Green) + "</b>");
            }
            else
            {
                Selections.Add((int)RecoreDef.IAP_Pack6, "<b><color=#00ff2a>Gói 199900 Đồng</color></b> cần <b>199900 KTCoin</b>");
            }
