...
namespace GameServer.Logic
{
    public partial class KuaFuMapManager : IManager, ICmdProcessorEx, IManager2
    {
        ...
        public bool InitConfig()
        {
            ...
            lock (RuntimeData.Mutex)
            {
                try
                {
                    ...
                    fullPathFileName = Global.GameResPath(MapLinesPath);
        ...
        // Kiểm tra xem bản đồ có vào được ko
        private bool CheckMap(KPlayer client)
        {
        ...
        /// <summary>
        /// Check choác trước khi gửi packet về cho nó chuyển máy chủ
        /// </summary>
            ...
            try
            {
                ...
                do
                {
                    ...
                    if (kuaFuServerId > 0)
                    {
                        ...
                        {
                            KTGlobal.GotoMap(client, toMapCode);
                        }
                        else
                        {
        ...
        public bool IsGongNengOpened(KPlayer client, bool hint = false)
        {
            return true;
        }
