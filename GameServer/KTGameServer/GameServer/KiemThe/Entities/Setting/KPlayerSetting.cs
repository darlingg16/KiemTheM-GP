...
namespace GameServer.KiemThe.Entities
{
    ...
    public class KPlayerSetting
    {
        ...
        public class KLEVEL_SETTING
        {
            ...
            public static KLEVEL_SETTING Parse(XElement xmlNode)
            {
                return new KLEVEL_SETTING()
                {
                    ...
                    nExp = int.Parse(xmlNode.Attribute("ExpNeed").Value),
        ...
        protected class KROUTE_SETTING
        {
            ...
            public static KROUTE_SETTING Parse(XElement xmlNode)
            {
                return new KROUTE_SETTING()
                {
                    ...
                    nRouteID = int.Parse(xmlNode.Attribute("SubID").Value),
        ...
        public static void Init()
        {
            ...
            {
                XElement xmlNode = Global.GetGameResXml("Config/KT_Setting/RoleLevelUpAttributes.xml");
            ...
            {
                XElement xmlNode = Global.GetGameResXml("Config/KT_Faction/FactionAttributes.xml");
                foreach (XElement node in xmlNode.Elements())
                {
        ...
        {
            KROUTE_SETTING routeSetting = KPlayerSetting.s_mpRouteSetting.Where(x => x.nFactionID == player.m_cPlayerFaction.GetFactionId() && x.nRouteID == player.m_cPlayerFaction.GetRouteId()).FirstOrDefault();
        ...
        /// <returns></returns>
        public static int GetStrength2DamagePhysics(int byFactionId, int byRouteId, int nStrength)
        {
            KROUTE_SETTING routeSetting = KPlayerSetting.s_mpRouteSetting.Where(x => x.nFactionID == byFactionId && x.nRouteID == byRouteId).FirstOrDefault();
            if (routeSetting == null)
            {
                return 0;
            }
        ...
        /// <returns></returns>
        public static int GetDexterity2AttackRate(int byFactionId, int byRouteId, int nDexterity)
        {
            KROUTE_SETTING routeSetting = KPlayerSetting.s_mpRouteSetting.Where(x => x.nFactionID == byFactionId && x.nRouteID == byRouteId).FirstOrDefault();
            if (routeSetting == null)
            {
        ...
        /// <param name="nDexterity"></param>
        /// <returns></returns>
        public static int GetDexterity2Defence(int byFactionId, int byRouteId, int nDexterity)
        {
            KROUTE_SETTING routeSetting = KPlayerSetting.s_mpRouteSetting.Where(x => x.nFactionID == byFactionId && x.nRouteID == byRouteId).FirstOrDefault();
            if (routeSetting == null)
            {
        ...
        /// <param name="nDexterity"></param>
        /// <returns></returns>
        public static int GetDexterity2DamagePhysics(int byFactionId, int byRouteId, int nDexterity)
        {
            KROUTE_SETTING routeSetting = KPlayerSetting.s_mpRouteSetting.Where(x => x.nFactionID == byFactionId && x.nRouteID == byRouteId).FirstOrDefault();
            if (routeSetting == null)
            {
        ...
        /// <returns></returns>
        public static int GetVitality2Life(int byFactionId, int byRouteId, int nVitality)
        {
            KROUTE_SETTING routeSetting = KPlayerSetting.s_mpRouteSetting.Where(x => x.nFactionID == byFactionId && x.nRouteID == byRouteId).FirstOrDefault();
            if (routeSetting == null)
            {
        ...
        /// <returns></returns>
        public static int GetEnergy2Mana(int byFactionId, int byRouteId, int nEnergy)
        {
            KROUTE_SETTING routeSetting = KPlayerSetting.s_mpRouteSetting.Where(x => x.nFactionID == byFactionId && x.nRouteID == byRouteId).FirstOrDefault();
            if (routeSetting == null)
            {
        ...
        /// <param name="nEnergy"></param>
        /// <returns></returns>
        public static int GetEnergy2DamageMagic(int byFactionId, int byRouteId, int nEnergy)
        {
            KROUTE_SETTING routeSetting = KPlayerSetting.s_mpRouteSetting.Where(x => x.nFactionID == byFactionId && x.nRouteID == byRouteId).FirstOrDefault();
            if (routeSetting == null)
            {
