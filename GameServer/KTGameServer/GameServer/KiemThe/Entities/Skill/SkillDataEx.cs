    ...
    public class SkillDataEx
    {
        ...
        public static SkillDataEx Parse(XElement xmlNode)
        {
            SkillDataEx skillData = new SkillDataEx()
            {
                ...
                WeaponLimit = int.Parse(xmlNode.Attribute("WeaponLimit").Value),
            ...
            LogManager.WriteLog(LogTypes.Skill, string.Format("Load skill {0} (ID: {1}) successfully!", skillData.Name, skillData.ID));
