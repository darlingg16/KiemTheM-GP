...
namespace GameServer.KiemThe.Entities
{
    ...
    public class KSkill
    {
        ...
        public static void LoadSkillData()
        {
            ...
            XElement attribNode = Global.GetGameResXml("Config/KT_Skill/SkillPropertiesLua.xml");
            ...
            XElement xmlNode = Global.GetGameResXml("Config/KT_Skill/SkillData.xml");
            ...
            XElement autoSkillNode = Global.GetGameResXml("Config/KT_Skill/AutoSkill.xml");
            ...
            XElement bulletConfigNode = Global.GetGameResXml("Config/KT_Skill/BulletConfig.xml");
            ...
            XElement enchantSkillNode = Global.GetGameResXml("Config/KT_Skill/EnchantSkill.xml");
