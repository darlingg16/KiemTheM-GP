...
namespace GameServer.KiemThe.LuaSystem
{
    ...
    public static partial class KTLuaEnvironment
    {
        ...
        #region Bot
        /// <summary>
        /// Thực hiện hàm AITick của script AI Bot
        /// </summary>
        /// <param name="scene"></param>
        /// <param name="bot"></param>
        /// <param name="scriptID"></param>
        public static void ExecuteBotAIScript_AITick(GameMap scene, KTBot bot, GameObject target, int scriptID, Action<UnityEngine.Vector2?> callback)
        {
            Lua_Scene luaScene = new Lua_Scene()
            {
                RefObject = scene,
            };
            Lua_Bot luaBot = new Lua_Bot()
            {
                RefObject = bot,
                CurrentScene = luaScene,
            };
        ...
        /// <summary>
        /// Thực hiện hàm Start của Bot
        /// </summary>
        /// <param name="scene"></param>
        /// <param name="monster"></param>
        /// <param name="scriptID"></param>
        public static void ExecuteBotScript_Start(GameMap scene, KTBot bot, int scriptID)
        {
            Lua_Scene luaScene = new Lua_Scene()
            {
                RefObject = scene,
        ...
        /// <summary>
        /// Thực hiện hàm Tick của Bot
        /// </summary>
        /// <param name="scene"></param>
        /// <param name="monster"></param>
        /// <param name="scriptID"></param>
        public static void ExecuteBotScript_Tick(GameMap scene, KTBot bot, int scriptID)
        {
            Lua_Scene luaScene = new Lua_Scene()
            {
                RefObject = scene,
        ...
        public static void ExecuteItemScript_Selection(GameMap scene, GoodsData itemGD, KPlayer player, int scriptID, int selectionID, Dictionary<int, string> otherParams)
        {
            ...
            KTLuaScript.Instance.ExecuteFunctionAsync(KTLuaEnvironment.LuaEnv, scriptID, "OnSelection", new object[] {
                ...
                GoodsData goodsData = Global.GetGoodsByDbID(player, itemGD.Id);
                /// Trả về kết quả
