...
namespace GameServer.KiemThe.LuaSystem.Entities
{
    ...
    public class Lua_Scene
    {
        ...
        {
            return GameManager.ClientMgr.GetMapClients(this.RefObject.MapCode).Count;
        }
        ...
        public Lua_Player[] GetPlayers()
        {
            ...
            List<KPlayer> objs = GameManager.ClientMgr.GetMapClients(this.RefObject.MapCode);
            /// Duyệt danh sách
        ...
        /// <summary>
        /// Trả về người chơi có ID tương ứng trong bản đồ
        /// </summary>
        /// <param name="roleID"></param>
        /// <returns></returns>
        public Lua_Player GetPlayer(int roleID)
        {
            /// Danh sách đối tượng trong bản đồ
            List<KPlayer> objs = GameManager.ClientMgr.GetMapClients((player) => { return player.RoleID == roleID; },this.RefObject.MapCode);
            /// Duyệt danh sách
            foreach (KPlayer obj in objs)
            {
        ...
        {
            return GameManager.MonsterMgr.GetObjectsByMap(this.RefObject.MapCode).Count;
        }
        ...
        public Lua_Monster[] GetMonsters()
        {
            ...
            /// Danh sách đối tượng trong bản đồ
            List<Monster> objs = GameManager.MonsterMgr.GetObjectsByMap(this.RefObject.MapCode);
            /// Duyệt danh sách
        ...
        {
            /// Đối tượng tương ứng
            Monster obj = GameManager.MonsterMgr.FindMonster(this.RefObject.MapCode, monsterID);
            /// Nếu tìm thấy
            if (obj != null)
            {
        ...
        {
            return NPCGeneralManager.GetMapNPCs(this.RefObject.MapCode).Count;
        }
        ...
        public Lua_NPC[] GetNPCs()
        {
            ...
            List<NPC> npcs = NPCGeneralManager.GetMapNPCs(this.RefObject.MapCode);
            /// Duyệt danh sách
