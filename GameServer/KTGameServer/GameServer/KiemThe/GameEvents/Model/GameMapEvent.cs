...
namespace GameServer.KiemThe.GameEvents.Interface
{
    ...
    public abstract class GameMapEvent : IDisposable
    {
        ...
        {
            return GameManager.ClientMgr.GetMapClientsCount(this.Map.MapCode);
        }
        ...
        {
            /// Trả về kết quả
            return GameManager.ClientMgr.GetMapClients(this.Map.MapCode);
        }
        ...
        {
            /// Trả về kết quả
            return GameManager.MonsterMgr.GetMonstersCount(this.Map.MapCode);
        }
        ...
        {
            /// Trả về kết quả
            return GameManager.MonsterMgr.GetObjectsByMap(this.Map.MapCode);
        }
        ...
        {
            return NPCGeneralManager.GetMapNPCs(this.Map.MapCode).Count;
        }
        ...
        protected List<NPC> GetNPCs()
        {
            ...
            return NPCGeneralManager.GetMapNPCs(this.Map.MapCode);
        }
