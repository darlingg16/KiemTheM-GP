...
namespace GameServer.KiemThe.GameEvents.BaiHuTang
{
    ...
    public class BaiHuTang_Script_Round3 : GameMapEvent
    {
		...
		public override bool OnPlayerClickReliveButton(KPlayer player)
        {
            ...
            PlayerManager.Relive(player, BaiHuTang.Round3.OutMaps[this.Map.MapCode].OutMapID, BaiHuTang.Round3.OutMaps[this.Map.MapCode].OutPosX, BaiHuTang.Round3.OutMaps[this.Map.MapCode].OutPosY, 100, 100, 100);
            return true;
        }
        #endregion
        ...
        private void CreateBoss()
        {
            ...
            GameManager.MonsterZoneMgr.AddDynamicMonsters(this.Map.MapCode, BaiHuTang.Round3.Boss.IDByActivity[this.Activity.Data.ID], -1, 1, randomPos.Key, randomPos.Value, BaiHuTang.Round3.Boss.Name, BaiHuTang.Round3.Boss.Title, hp, this.Level, dir, series, (MonsterAIType) BaiHuTang.Round3.Boss.AIType, -1, -1, BaiHuTang.Round3.Boss.AIScriptID, null, (monster) => {
        ...
        {
            KDynamicArea teleport = KTDynamicAreaManager.Add(this.Map.MapCode, -1, BaiHuTang.Round3.Teleport.Name, BaiHuTang.Round3.Teleport.ResID, (int) BaiHuTang.Round3.Teleport.PosX, (int) BaiHuTang.Round3.Teleport.PosY, (this.DurationTicks - this.LifeTimeTicks) / 1000f, 2f, BaiHuTang.Round3.Teleport.Radius, -1, null);
        ...
        {
            GameManager.ClientMgr.NotifyChangeMap(Global._TCPManager.MySocketListener, Global._TCPManager.TcpOutPacketPool, player, BaiHuTang.Round3.OutMaps[this.Map.MapCode].OutMapID, BaiHuTang.Round3.OutMaps[this.Map.MapCode].OutPosX, BaiHuTang.Round3.OutMaps[this.Map.MapCode].OutPosY, (int) player.CurrentDir);
        }
