...
namespace GameServer.KiemThe.CopySceneEvents.MilitaryCampFuBen
{
    ...
    public static class MilitaryCamp
    {
        ...
        public class EventCondition
        {
            ...
            /// </summary>
            public int RoundsPerWeek { get; set; }
            ...
            public static EventCondition Parse(XElement xmlNode)
            {
                return new EventCondition()
                {
                    ...
                    RoundsPerWeek = int.Parse(xmlNode.Attribute("RoundsPerWeek").Value),
                };
            }
        }
                ...
                public class TriggerData
                {
                    ...
                    public class KeyTriggerInfo
                    {
                        ...
                        public static KeyTriggerInfo Parse(XElement xmlNode)
                        {
                            ...
                            {
                                ID = int.Parse(xmlNode.Element("ID").Value),
                                TriggerID = int.Parse(xmlNode.Element("TriggerID").Value),
                                ObstacleTriggerID = int.Parse(xmlNode.Element("ObstacleTriggerID").Value),
                                Name = xmlNode.Element("Name").Value,
                                PosX = int.Parse(xmlNode.Element("PosX").Value),
                                PosY = int.Parse(xmlNode.Element("PosY").Value),
                                CollectTick = int.Parse(xmlNode.Element("CollectTick").Value),
                            };
                        }
                    }
                    ...
                    public class ObstacleTriggerInfo
                    {
                        ...
                        public static ObstacleTriggerInfo Parse(XElement xmlNode)
                        {
                            return new ObstacleTriggerInfo()
                            {
                                ...
                                PosX = int.Parse(xmlNode.Element("PosX").Value),
                                PosY = int.Parse(xmlNode.Element("PosY").Value),
                                ToPosX = int.Parse(xmlNode.Element("ToPosX").Value),
                                ToPosY = int.Parse(xmlNode.Element("ToPosY").Value),
                            };
                        }
                    }
                    ...
                    public class TrapInfo
                    {
                        ...
                        public static TrapInfo Parse(XElement xmlNode)
                        {
                            return new TrapInfo()
                            {
                                ...
                                PosX = int.Parse(xmlNode.Element("PosX").Value),
                                PosY = int.Parse(xmlNode.Element("PosY").Value),
                                TouchMessage = xmlNode.Element("TouchMessage").Value,
                            };
                        }
                    }
                    ...
                    public static TriggerData Parse(XElement xmlNode)
                    {
                        ...
                        {
                            KeyTriggerInfo trigger = new KeyTriggerInfo()
                            {
                                ID = int.Parse(node.Attribute("ID").Value),
                                TriggerID = int.Parse(node.Attribute("TriggerID").Value),
                                ObstacleTriggerID = int.Parse(node.Attribute("ObstacleTriggerID").Value),
                                Name = node.Attribute("Name").Value,
                                PosX = int.Parse(node.Attribute("PosX").Value),
                                PosY = int.Parse(node.Attribute("PosY").Value),
                                CollectTick = int.Parse(node.Attribute("CollectTick").Value),
                            };
                        ...
                        {
                            ObstacleTriggerInfo trigger = new ObstacleTriggerInfo()
                            {
                                ID = int.Parse(node.Attribute("ID").Value),
                                TriggerID = int.Parse(node.Attribute("TriggerID").Value),
                                Name = node.Attribute("Name").Value,
                                PosX = int.Parse(node.Attribute("PosX").Value),
                                PosY = int.Parse(node.Attribute("PosY").Value),
                                ToPosX = int.Parse(node.Attribute("ToX").Value),
                                ToPosY = int.Parse(node.Attribute("ToY").Value),
                            };
                    ...
                    public static TaskInfo Parse(XElement xmlNode)
                    {
                        ...
                        switch (taskInfo.Type)
                        {
                            ...
                            case TaskType.KillBoss:
                            {
                                ...
                                /// Nếu có Boss con
                                if (xmlNode.Element("ChildBos") != null)
                                {
        ...
        {
            XElement xmlNode = Global.GetGameResXml("Config/KT_CopyScenes/MilitaryCamp.xml");
            /// ID sự kiện
            MilitaryCamp.EventID = int.Parse(xmlNode.Attribute("EventID").Value);
