...
namespace GameServer.KiemThe.CopySceneEvents
{
    ...
    public static partial class CopySceneEventManager
    {
        ...
        public static int GetCopySceneTotalEnterTimesToday(KPlayer player, AcitvityRecore copySceneType)
        {
        ...
        public static void SetCopySceneTotalEnterTimesToday(KPlayer player, AcitvityRecore copySceneType, int totalEnterTimes)
        {
