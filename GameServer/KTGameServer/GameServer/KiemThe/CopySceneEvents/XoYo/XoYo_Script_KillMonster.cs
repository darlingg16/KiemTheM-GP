...
namespace GameServer.KiemThe.CopySceneEvents.XiaoYaoGu
{
	...
	/// </summary>
	public class XoYo_Script_KillMonster : CopySceneEvent
	{
		#region Constants
		/// <summary>
		...
		public XoYo_Script_KillMonster(KTCopyScene copyScene, XoYo.MapInfo mapInfo) : base(copyScene)
		{
		...
		protected override void OnTick()
		{
			...
			if (this.LifeTimeTicks <= XoYo.BeginWaitTime)
			{
				...
				if (KTGlobal.GetCurrentTimeMilis() - this.LastNotifyTick >= XoYo_Script_KillMonster.NotifyActivityInfoToPlayersEveryTick)
				{
