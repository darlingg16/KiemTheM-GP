...
namespace GameServer.KiemThe.Logic.Manager
{
    ...
    public static partial class KTGrowPointManager
    {
        ...
        public static void RemoveGrowPointAndRespawn(GrowPoint growPoint)
        {
            ...
            /// Nếu thời gian tái sinh quá nhỏ
            if (growPoint.RespawnTime == -100)
            {
                return;
            }
            ...
            {
                Name = "GrowPoint respawn",
                Loop = false,
                Interval = growPoint.RespawnTime / 1000f,
                Work = () =>
                {
                    /// Tái sinh
        ...
        public static void GrowPointClick(KPlayer player, int growPointID)
        {
            ...
            {
                PlayerManager.ShowNotification(player, "Trong trạng thái bị khống chế, không thể thực hiện thao tác!");
                return;
            }
            ...
            {
                PlayerManager.ShowNotification(player, "Đối tượng không tồn tại!");
                return;
            }
            ...
            if (!growPoint.Alive)
            {
                PlayerManager.ShowNotification(player, "Đối tượng đã bị người khác thu thập!");
                return;
            }
