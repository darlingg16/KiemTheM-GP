    ...
    public static partial class KTSkillManager
    {
        ...
        public static void DoAruaLogic(GameObject caster, GameObject target, SkillLevelRef skill)
        {
            ...
            else if (skill.Data.TargetType != "self")
            {
                ...
                if (skill.Data.TargetType == "teamnoself")
                {
                    if (caster is KPlayer)
                    {
                        List<KPlayer> teammates = KTLogic.GetNearByTeammates(caster as KPlayer, auraRange, 6);
                ...
                {
                    List<GameObject> friends = KTLogic.GetNearBySameCampObject(caster, auraRange, 6);
                ...
                else if (skill.Data.TargetType == "ally" || skill.Data.TargetType == "allyandnpc")
                {
                    ...
                    {
                        List<Monster> friends = KTLogic.GetNearBySameCampObject<Monster>(caster as Monster, auraRange, 6);
                ...
                {
                    List<GameObject> enemies = KTLogic.GetNearByEnemies(caster, auraRange, 10);
                ...
                {
                    List<Monster> monsters = KTLogic.GetNearByObjects<Monster>(caster, auraRange, 10);
            ...
            if (childSkill != null)
            {
                ...
                KTSkillManager.UseSkill_DoAction(caster, null, target, null, skillRef, true);
            }
        }
        ...
        public static void DoOffensiveAruaLogic(GameObject caster, GameObject target, SkillLevelRef skill, bool isChildCall, string auraStyle)
        {
            ...
            else
            {
                ...
                {
                    List<GameObject> enemies = KTLogic.GetNearByEnemies(caster, 520, targetCount);
                    int enemiesCount = 0;
                    foreach (GameObject enemy in enemies)
                    {
                        /// Nếu là chiêu đánh
