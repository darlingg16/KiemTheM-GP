...
namespace GameServer.KiemThe.Logic
{
    ...
    public class KNPCDialog
    {
        ...
        public void Show(NPC npc, KPlayer player)
        {
            ...
            KT_TCPHandler.OpenNPCDialog(player, npc.NPCID, this.ID, this.Text, this.Selections, this.Items, this.ItemSelectable, this.OtherParams);
        }
        ...
        public void ShowDialog(KPlayer player)
        {
            ...
            KTNPCDialogManager.AddNPCDialog(this);
            /// Gửi gói tin về Client
            KT_TCPHandler.OpenNPCDialog(player, -1, this.ID, this.Text, this.Selections, this.Items, this.ItemSelectable, this.OtherParams);
        }
    }
}
